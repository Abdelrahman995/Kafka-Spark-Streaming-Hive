...
public class TwitterKafkaProducer {
    ...
    public TwitterKafkaProducer() {
        ...
        // track the terms of your choice. here im only tracking #COVID19.
        StatusesFilterEndpoint endpoint = new StatusesFilterEndpoint();
        endpoint.trackTerms(Collections.singletonList(TwitterConfiguration.HASHTAG));
        endpoint.trackTerms(Collections.singletonList("corona"));
        endpoint.trackTerms(Collections.singletonList("stayathome"));
        endpoint.trackTerms(Collections.singletonList("stayhome"));
        endpoint.trackTerms(Collections.singletonList("workfromhome"));
        endpoint.trackTerms(Collections.singletonList("covid-19"));
